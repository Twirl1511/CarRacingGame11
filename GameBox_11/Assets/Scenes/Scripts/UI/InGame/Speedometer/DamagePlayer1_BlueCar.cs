...
public class DamagePlayer1_BlueCar : MonoBehaviour
{
    ...
    private void DamageDone()
    {
        ...
        if (crushesCounter > 2)
        {
            Player1_DamageBar3.fillAmount -= Time.deltaTime*8;
        }
        //switch (crushesCounter)
        //{
        //    case 1:
        //        Player1_DamageBar1.fillAmount -= Time.deltaTime;
        //        break;
        //    case 2:
        //        Player1_DamageBar2.fillAmount -= Time.deltaTime;
        //        break;
        //    case 3:
        //        Player1_DamageBar3.fillAmount -= Time.deltaTime;
        //        break;
        //    default:
        //        break;
        //}
