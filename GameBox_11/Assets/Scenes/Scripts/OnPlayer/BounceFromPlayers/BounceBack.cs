...
public class BounceBack : MonoBehaviour
{
    ...
    private void OnTriggerStay2D(Collider2D collision)
    {
        ...
        {
            collision.GetComponent<Rigidbody2D>().AddForce(transform.up * -1 * TaranForceForMoto);
        ...
        {
            collision.GetComponent<Rigidbody2D>().AddForce(transform.up * -1 * TaranForceForCar);
